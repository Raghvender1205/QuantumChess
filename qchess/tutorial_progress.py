        ...
        for tutorial_name, completed in self.progress_table.items():
            ...
            try:
                json_data = open(os.path.join(
                    'tutorials', tutorial_name + '.json'))
            except FileNotFoundError:
                print(
                    'Error while loading tutorial file {} - File not found'.format(first))
                return
            ...
            print('Completed {}/{}.'.format(completed_tutorial_number,
                                            len(self.progress_table)))
