...
class TestJumpMove(unittest.TestCase):
    def test_split_move(self):
        ...
        engine.set_board_factory(3, 3, lambda qchess: qchess.add_piece(
    ...
    def test_blocked_move(self):
        ...
        def board_factory(qchess):
            ...
            qchess.split_move(Point(0, 0), Point(1, 0),
                              Point(0, 1), force=True)
            qchess.split_move(Point(1, 0), Point(1, 1),
                              Point(2, 1), force=True)
